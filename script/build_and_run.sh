...
<dict>
  ...
  <string>Subs captures local system audio for realtime subtitles and translation.</string>
  <key>NSSpeechRecognitionUsageDescription</key>
  <string>Subs transcribes local meeting audio on this Mac for realtime subtitles.</string>
</dict>
</plist>
PLIST
